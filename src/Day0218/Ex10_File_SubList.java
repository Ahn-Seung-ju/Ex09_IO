...
public class Ex10_File_SubList {
    ...
    static void printFileList(File dir) {
        ...
        List<Integer> subdirt = new ArrayList<Integer>();
        ...
        //POINT(폴더 안에 폴더(하위 폴더))도 보고 싶으면 재귀함수
        for(int j = 0; j < subdirt.size(); j++) {
            int index = subdirt.get(j);
            //index 2
            //printFileList(C:\\Temp1\\2021)
            
            //index 3
            //printFileList(C:\\Temp1\\2022)
